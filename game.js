...
function createLighting() {
    ...
    sunLight.shadow.camera.far = WORLD_SIZE * GRID_SIZE * 4; // 距離を2倍から4倍に増加
    sunLight.shadow.camera.left = -WORLD_SIZE * GRID_SIZE * 2;
    sunLight.shadow.camera.right = WORLD_SIZE * GRID_SIZE * 2;
    sunLight.shadow.camera.top = WORLD_SIZE * GRID_SIZE * 2;
    sunLight.shadow.camera.bottom = -WORLD_SIZE * GRID_SIZE * 2;
    scene.add(sunLight);
